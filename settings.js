...
global.owner = process.env.OWNER_NUMBER  || '923377507791' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=fMUSUJgb#ukqAwc3WwoWViLHoNu74mPfo6vwBPHWx9Gick9IIyww' ,
